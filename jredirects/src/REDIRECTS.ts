...
export const permanent: redirects={ //301
    ...
    'https://docs.google.com/document/d/1hjc1ZM9gfHd7VsPnQcnHtzrVOx8RguzEajhax7rk7Ww/edit': '/agenda',
    '/the-state-of-the-e-bus': ['/state-of-the-e-bus', '/the-state-of-the-electric-bus', '/the-state-of-electric-buses', '/state-of-the-electric-bus', '/state-of-the-electric-buses', '/state-of-the-ebus', '/state-of-the-ebuses']
};
